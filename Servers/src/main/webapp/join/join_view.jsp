...
<body>
	<form name="joinForm" method="post" action="join_db.jsp">
		...
		<p>
			우편번호 <input name="zipcode" type="text" id="sample6_postcode" placeholder="우편번호">
		...
		<p>
			상세주소 <input type="text" id="sample6_detailAddress" placeholder="상세주소" name="addrdetail">
		</p>
		<p>
			참고항목 <input type="text" id="sample6_extraAddress" placeholder="참고항목" name="addretc">
		</p>
		<p>
