  ...
  <div class="login-form">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-12">
          <form id="login-form" method="post" name="gs"  action="loginAction.jsp">
            <div class="row">
              <div class="col-lg-12">
                <a href="../index.html"><img src="../assets/images/withpill_blue.png" alt="" class="logo"></a>
                
              </div>
              <div class="col-lg-12">
                  <fieldset>
                      <label for="Name" class="form-label">아이디</label>
                      <input type="text" name="userId" class="id" placeholder="아이디 또는 이메일을 입력하세요" autocomplete="on" >
                  </fieldset>
              </div>
              <div class="col-lg-12">
                <fieldset>
                    <label for="Number" class="form-label">비밀번호</label>
                    <input type="password" name="userPw" class="pw" placeholder="비밀번호를 입력하세요" autocomplete="on" >
                </fieldset>
              </div>
              
              <div class="col-lg-12">                        
            	<fieldset >
                   <button class="main-button" onclick="sendit();">로그인</button> 
                </fieldset> 
                
         <!--        <input type="button"  value="로그인" onclick="sendit();">
                <button onclick="alert('Submit')" type="submit">전송 버튼</button> -->
                
               
              </div>
              <nav>
                <a href="../join/findpw.jsp">비밀번호 찾기</a>
                <span>|</span>
...
<!-- sns login -->
<div class="sign-in-modal__social-sign-in social-btns-wrap">

  <!-- <span class="social-sign-in__title"><h3>간편 로그인</h3></span> -->
  <div class="social__sign-in-buttons social-btns">
