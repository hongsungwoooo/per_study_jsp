						...
						<c:forEach var="reply" items="${replylist }">
							<tr>
								...
								<td valign="top" style="padding-left: 10px;">
									<textarea id="reply${reply.replynum }" name="reply${reply.replynum }" style="text-align: left; border: 0px;width: 680px;height: 85px;resize: none;" readonly>${reply.replycontents} </textarea>
